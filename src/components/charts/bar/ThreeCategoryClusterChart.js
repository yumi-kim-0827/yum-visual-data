...
const ThreeCategoryClusterChart = ({
  myData,
  firstDataKey,
  secondDataKey,
  threeDataKey,
  ...
  const memoizedMyData = useMemo(
    () => myData,
    [myData, firstDataKey, secondDataKey, threeDataKey]
  );
  console.log(myData);
  useLayoutEffect(() => {
    ...
    createSeries(`${threeDataKey}`, `${threeDataKey}`);
  ...
  }, [memoizedMyData, theme, firstDataKey, secondDataKey, threeDataKey]);

  return <div id="chartdiv" style={{ width: "100%", height: "500px" }}></div>;
};

export default ThreeCategoryClusterChart;
